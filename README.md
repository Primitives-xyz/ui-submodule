...
```
yarn add tailwind-merge tailwindcss-animate class-variance-authority zod swr react-use-clipboard react-hook-form @hookform/resolvers lucide-react @radix-ui/react-slot @radix-ui/react-dialog @radix-ui/react-dropdown-menu @radix-ui/react-label @radix-ui/react-popover @radix-ui/react-separator @radix-ui/react-select @radix-ui/react-tooltip @radix-ui/react-accordion @radix-ui/react-progress
```
