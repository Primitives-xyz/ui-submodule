  ...
  (
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          'fixed left-1/2 top-1/2 z-50 grid w-[90vw] max-w-xs -translate-x-1/2 -translate-y-1/2 gap-5 border bg-modal text-modal-foreground p-6 shadow-lg rounded-lg outline-hidden backdrop-blur-md',
          {
