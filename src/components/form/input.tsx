    ...
    return (
      <div className="relative">
        ...
        <input
          type={type}
          className={cn(
            'flex file:py-2 h-9 w-full rounded-input border bg-input px-3 ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50',
            {
